    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/account-types").hasRole("USER")
                        .requestMatchers("/api/account-sub-types").hasRole("USER")
                        .requestMatchers("/api/transaction-types").hasRole("USER")
                        .requestMatchers("/api/expenses/**").hasRole("USER")
                        .requestMatchers("/api/expense-categories/**").hasRole("USER")
                        .requestMatchers("/api/expense-sub-categories/**").hasRole("USER")
